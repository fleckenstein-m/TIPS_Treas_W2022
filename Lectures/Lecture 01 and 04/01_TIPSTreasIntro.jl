...
<input type="checkbox" value="">Understand Treasury notes, bonds, TIPS, and STRIPS.<br><br>
<input type="checkbox" value="">Understand what inflation swaps are and how they work.<br><br>
<input type="checkbox" value="">Understand how to implement the TIPS-Treasury arbitrage strategy.<br><br>
</fieldset>      
	"""
end
