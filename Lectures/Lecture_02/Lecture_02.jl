...
- The Department of the Treasury is the single largest issuer of debt in the world.
- The large volume of total debt and the large size of any single issue have contributed to making the Treasury market the most active and hence the most liquid fixed-income market in the world.
...
# ╔═╡ ef7d5836-22df-4280-a430-86b4e81759c7
md"""
### U.S. Treasury Securities Amounts Outstanding
"""

# ╔═╡ 313959e0-eea6-449a-a6b8-29c9394e50b6
LocalResource("./TreasuryOutstandingSIFMA.jpg",:width => 900)
...
# ╔═╡ 9e69e681-bf6f-4fef-b0c8-f71bd8ce4c0f
md"""
### U.S. Treasury Securities Issuance
"""

# ╔═╡ 13a58974-2ae8-4596-933f-5d2b5b8f5a23
LocalResource("./TreasuryIssuanceSIFMA.jpg",:width => 900)
...
>- Go to webpage of the [U.S. Treasury](https://www.treasurydirect.gov/marketable-securities/).
...
Foldable("Coupon Bond", LocalResource("TreasuryCouponPicture.svg",:width => 900))

# ╔═╡ a339f36e-f0c1-4c71-aef0-1b4ad943c1bf
Foldable("Clipping Coupons",LocalResource("BING_02.jpg"))
...
# ╔═╡ 3a6d26b9-d1d6-48b0-b018-7ba3a16b3686
html"""
...
# ╔═╡ f54a1f8a-b9ca-4a92-b36b-7cf44cf2b7b6
vspace

# ╔═╡ 77dcfb3e-97e5-4408-8c07-7fef5f0e5a8c
html"""
