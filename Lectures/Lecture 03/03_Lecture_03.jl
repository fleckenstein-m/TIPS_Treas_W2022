...
Markdown.parse("""
!!! hint
Price in Decimals: ``$(roundmult(p161+p162/32,1e-6))``
""")
...
Markdown.parse("""
!!! hint
Price in Decimals: ``$(roundmult(p191+(p192+p193/8)/32,1e-6))``
""")
...
Markdown.parse("""
!!! hint
- **Step 1:** There are $(daysAIPeriod) days in the Accrued Interest Period.
""")

# ╔═╡ bbc947d4-0c02-4398-8daa-72d64f00b6a3
Markdown.parse("""
!!! hint
- **Step 2:** There are $(daysCpnPeriod) days in the Coupon Period.
""")

# ╔═╡ cfd69cc4-d5aa-4c85-89aa-1356e24cf8b0
Markdown.parse("""
!!! hint
- **Step 3:** The dollar coupon cash flow is

    \$\\frac{$cpnAI_3\\%}{2} \\times 100 = $((cpnAI_3/100)/2*100)\$	
""")
...
md"""
!!! hint
- The price is $$P=100 \times \left( 1- y_d \times \frac{\textrm{Days to Maturity}}{360}\right)= \$100 \times \left( 1- 1.5225\% \times \frac{80}{360}\right)=\$99.6617$$
"""
...
[[deps.Mustache]]
deps = ["Printf", "Tables"]
git-tree-sha1 = "f88af2b567210f246f082f59e42bee00eb1ee3e1"
