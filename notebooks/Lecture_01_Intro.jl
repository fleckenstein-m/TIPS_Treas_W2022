...
# ╔═╡ 9a8e1c63-f27c-441b-8eb6-aca30f4ca2d8
# ╠═╡ show_logs = false
begin
	using Logging
...
begin
	...
	using DataFrames, HTTP, CSV, Dates, Plots, PlutoUI, Printf, LaTeXStrings, HypertextLiteral, ShortCodes, XLSX
...
begin 
	...
	<p align=center style="font-size:25px; font-family:family:Georgia"> Summer 2024 <p>
	<p style="padding-bottom:0.5cm"> </p>
...
# ╔═╡ 37aa21fb-f73a-4f28-829d-d1a4edbd1de7
md"""
##
"""
...
# ╔═╡ d6477225-6ca6-4444-83ad-be1a5d95abc0
md"""
##
"""
...
# ╔═╡ 8f4a669a-b3c5-4c41-a6fa-0ffd813301c2
md"""
##
"""
...
# ╔═╡ 058954fc-a121-4054-aa74-0b433f6a4d29
md"""
##
"""

# ╔═╡ 8957e58a-d454-49e9-a00f-bff4bf6b5199
# ╠═╡ show_logs = false
begin
	FI_Out = DataFrame()
	plot_Outstanding = plot()
	let
		file="./Assets/US-Fixed-Income-Securities-Statistics-SIFMA.xlsx"
		sheet="Outstanding"
		cols="A:I"
		startrow = 8
		...
		plot!(plot_Outstanding, plotData.x,plotData.y, 
			...
			legend = :topleft, title="U.S. Treasury Debt Amount Outstanding")	
		plot(plot_Outstanding)
	end
end

# ╔═╡ 22b298e8-bd1d-4b75-91de-56a9936dee51
md"""
##
"""

# ╔═╡ 4164b034-8a34-40dc-889b-e4072d54475b
md"""
...
# ╔═╡ 1af70d1f-1a99-474c-86fb-9d855754f520
md"""
##
"""
...
manifest_format = "2.0"
project_hash = "19c9bc612e2d777cdb46bbc293c36151469f69cc"
